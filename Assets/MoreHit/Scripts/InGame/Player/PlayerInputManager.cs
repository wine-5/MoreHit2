...
namespace MoreHit.Player
{
    ...
    public class PlayerInputManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            mainAttackAction = playerInput.actions["MainAttack"];
        ...
        private void OnEnable()
        {
            ...
            mainAttackAction.performed += OnMainAttack;
            mainAttackAction.canceled += OnMainAttackCanceled;
        ...
        {
            // メイン攻撃の溜め処理
            if (mainAttackAction.IsPressed() && !isChargingAttack)
            {
